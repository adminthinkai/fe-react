...
import '../signUp/styles.model.scss';
        ...
        <div className="authWrapper min-w-[580px]">
          <div className="navigationWrapper">
            <div className="flex flex-col items-center">
              ...
              <div className="flex w-[41px]  h-0.5  bg-green-400 rounded-[100px]" />
            </div>
            <div className="justify-center content-center">
              ...
              <div className="w-[41px] invisible h-0.5 bg-green-400 rounded-[100px]" />
            </div>
          </div>
          <LoginForm />
        </div>
